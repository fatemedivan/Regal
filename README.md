...
**Regal | فروشگاه آنلاین فول استک پوشاک زنانه**

تکنولوژی‌ها: Next.js, TypeScript, Tailwind CSS, Prisma, PostgreSQL
ویژگی‌ها: معماری ماژولار، طراحی ریسپانسیو، جستجو و فیلتر هوشمند، سبد خرید پویا، پنل کاربری کامل
