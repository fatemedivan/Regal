...
export default function Page() {
  ...
  const handleSubmit = async () => {
    try {
      setIsLoading(true);
      const response = await fetch("https://regal-api.vercel.app/auth/login", {
        method: "POST",
          ...
          <div>
            ...
            <div className="mt-56 flex flex-col justify-center items-center lg:items-start lg:mt-7.5">
              <button
                ...
                className={`leading-5.5 rounded-lg py-3.25 px-25 cursor-pointer w-full lg:text-lg lg:leading-6.5 lg:py-3.75 flex justify-center items-center ${
