      ...
      <div className="lg:flex gap-6 my-12">
        ...
        <div>
          ...
          <p className="leading-7 text-neutral-gray-13 mt-4 mb-2 lg:hidden">
            لباس میدی دکلته الی یکی از آیتم‌های شیک و جذاب در دنیای مد زنانه است
            که به‌طور خاص برای مهمانی‌ها و مناسبت‌های خاص طراحی شده است.
          </p>
          <p className="text-sm leading-6 text-neutral-gray-13 mt-4 mb-4 hidden lg:block">
            لباس میدی دکلته الی یکی از آیتم‌های شیک و جذاب در دنیای مد زنانه است
            که به‌طور خاص برای مهمانی‌ها و مناسبت‌های خاص طراحی شده است. این
            لباس با ظاهری زیبا و جزئیات دقیق، انتخابی ایده‌آل است.
          </p>
