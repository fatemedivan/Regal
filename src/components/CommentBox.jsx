...
export default function CommentBox({ img, name, city, title, desc, rating = 5 }) {
  const totalStars = 5
  ...
  return (
    <div className='min-w-64.5'>
      ...
      <div>
        <p className='text-neutral-gray-13 text-sm leading-5 lg:text-[20px] lg:leading-8.5'>{title}</p>
        <p className='text-neutral-gray-13 text-xs leading-4.5 mt-1 mb-2 lg:text-[1rem] lg:leading-7'>{desc}</p>
