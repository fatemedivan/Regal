            ...
            <div className='bg-black p-5 lg:hidden'>
                ...
                <div className='flex mt-8 gap-13'>
                    <ul>
                        ...
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">قوانین و مقررات</a></li>
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">حریم خصوصی</a></li>
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">سوالات متداول</a></li>
                    </ul>
                    <ul>
                        <li className='mb-3 ml-1.25 text-white flex justify-center items-center gap-2.5'>
                            <div className='w-1.5 h-1.5 rounded-full bg-white'></div>
                        ...
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">پیراهن کوتاه</a></li>
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">شومیز و دامن</a></li>
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">شلوار</a></li>
                        <li className='px-4 py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">سرهمی</a></li>
                ...
                <div className='flex items-center mt-4'>
                    ...
                    <p className='mr-2 text-neutral-gray-9 leading-4.5 text-xs'>تمامی حقوق مادی و معنوی برای مجموعه رگال محفوظ است.</p>
                </div>
            </div>
                ...
                <div className='flex items-center border-b-1 border-neutral-gray12'>
                    ...
                    <div className='flex gap-8 mt-20 mb-12'>
                        <ul>
                            ...
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">قوانین و مقررات</a></li>
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">حریم خصوصی</a></li>
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">سوالات متداول</a></li>
                        </ul>
                        <ul>
                            <li className='mb-6 text-white flex justify-center items-center gap-2.5'>
                                <div className='w-1.5 h-1.5 rounded-full bg-white'></div>
                            ...
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">پیراهن کوتاه</a></li>
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">شومیز و دامن</a></li>
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">شلوار</a></li>
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">سرهمی</a></li>
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">کت و ترنچ کت</a></li>
                        </ul>
                        <ul>
                            <li className='mb-6 text-white flex justify-center items-center gap-2.5'>
                                <div className='w-1.5 h-1.5 rounded-full bg-white'></div>
                            ...
                            <li className='py-2.5 text-neutral-gray-3 leading-6 text-sm'><a href="">تماس با ما</a></li>
