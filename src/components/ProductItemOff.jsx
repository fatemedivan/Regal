...
export default function ProductItemOff({ img, title, price, finalPrice, offPercent, isMore }) {
    return (
        <div className='max-w-41.75 lg:max-w-79.5'>
            ...
            <div className='lg:flex lg:justify-between lg:items-center lg:mt-3 lg:mb-2'>
            ...
            <div className='flex justify-between items-center gap-2 text-black lg:justify-start'>
