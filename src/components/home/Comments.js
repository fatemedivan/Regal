...
export default function Comments() {
  ...
  return (
    <section className="overflow-hidden pr-5 py-16 lg:pr-38 lg:pt-28 lg:pb-38 xl:pl-3 relative">
      <div className="container mx-auto">
        <img
          className="absolute hidden lg:block -right-[35%] -bottom-20 xl:-right-[25%] w-200 h-200"
          src="/img/pattern-right.png"
          alt=""
        />
        <img
          className="absolute hidden lg:block bottom-75 -left-[50%] xl:-left-[35%] xl:bottom-60 rotate-180 w-200 h-150"
          src="/img/pattern-left.png"
          alt=""
        />
