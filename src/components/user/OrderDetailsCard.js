    ...
    <div className="p-3 border border-neutral-gray-4 rounded-xl mb-4">
      <div className="flex justify-between items-center mb-3.5">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* نمایش وضعیت سفارش */}
          <div
            className={`text-xs leading-4.5 py-0.5 px-2 rounded-100 ${status === "pending"
      ...
      <div
        className={`flex gap-1 ${status === "pending" && deliveryType === "delivery"
          ? "mb-8"
          : "mb-3"
          }`}
      >
      ...
      <div
        className={`${status === "pending" && deliveryType === "delivery" ? "pt-8" : ""
